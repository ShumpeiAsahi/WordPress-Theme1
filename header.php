...
<header class="bg-cyan">
	<div class="container">
		<?php if ( is_home() ) { ?>
			    <h1 class="h1 py-3 text-white mb-0"><a href="<?php echo home_url(); ?>" class="text-white text-decoration-none"><?php bloginfo('name'); ?></a></h1>
		<?php } else { ?>
			    <div class="h1 py-3 text-white mb-0"><a href="<?php echo home_url(); ?>" class="text-white text-decoration-none"><?php bloginfo('name'); ?></a></div>
		<?php } ?>
	</div>
</header>
<!---グローバルナビ--->
<nav class="navbar navbar-expand-lg navbar-light bg-cyan">
	<div class="container">
		...
		<div class="collapse navbar-collapse py-2 text-decoration-none" id="navbarNav">
			<?php
			$defaults = array(
